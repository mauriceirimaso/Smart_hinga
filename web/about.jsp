...
footer {
    ...
    <body>
        ...
        <section class="mission">
            <div class="ad">
            <h2 class="ourm">OUR MISSION</h2>
            <P>At HINGA TRACTORS, our mission is to revolutionize the farming industry by providing modern, efficient, and sustainable agricultural cars for rent. We are committed to empowering farmers with cutting-edge technology and reliable equipment that enhances productivity, reduces manual labor, and maximizes crop yields.</P>
            <button class="btn"><a href="contactus.jsp">CONTACT US</a></button>
        </div>
            <div class="cimg">
            </div>
        </section>
